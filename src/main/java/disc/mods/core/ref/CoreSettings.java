...
public class CoreSettings
{
	public static class Debug
	{
		...
		public static ConfigProperty<Boolean> EnableDebug = new ConfigBoolean("EnableDebug", true, Debug).SetComment("Enable Debug Mode");
		public static ConfigProperty<Boolean> EnableTestBlock = new ConfigBoolean("EnableTestBlock", true, Debug).SetComment("Enable Test Block");
