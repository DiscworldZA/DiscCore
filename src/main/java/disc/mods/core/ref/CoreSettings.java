...
public class CoreSettings {
	public static class Debug {
		...
		public static ConfigProperty<Boolean> EnableDebug = new ConfigBoolean("EnableDebug", false, Debug)
				.SetComment("Enable Debug Mode");
		public static ConfigProperty<Boolean> EnableTestBlock = new ConfigBoolean("EnableTestBlock", false, Debug)
				.SetComment("Enable Test Block");
		public static ConfigProperty<String> TestBlockName = new ConfigString("TestBlockName", "TestBlock", Debug)
				.SetComment("Name of the Test Block");
